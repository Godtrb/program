...
while True:
    ...
    match opcion:
        ...
        case 4:
            codtochange = busqueda.buscar_codigo_2()
            Inventario.modif(inventario,codtochange)
            pass
        case 5:
            codtochange = busqueda.buscar_codigo_2()
            Inventario.eliminate (inventario,codtochange)
            pass
        case 6:
            print("Adiós, vuelva pronto.")
            break
